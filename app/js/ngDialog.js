                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            $dialog.html((options.overlay ?
                                ...
                                '<div class="ngdialog-content row" role="document">' + template + '</div>'));
                            ...
                            closeByDocumentHandler = function (event) {
                                ...
                                var isCloseMobileBtn = $el(event.target).hasClass('ngdialog-close-mobile');

                                if (isOverlay || isCloseBtn || isCloseMobileBtn) {
